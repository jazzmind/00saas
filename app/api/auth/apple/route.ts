...
/**
 * API Route: Apple Sign In
 * 
 * This endpoint handles Apple Sign In authentication:
 * 1. Verifies the Apple ID token
...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      // Verify the ID token
      const payload = jwt.verify(idToken, process.env.APPLE_PUBLIC_KEY!, {
        algorithms: ['RS256'],
